...
function c999999962.initial_effect(c)
	...
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcFunRep(c,c999999992.matfilter,2,false)
	--special summon rule
	...
	e8:SetTarget(c999999992.target)
...
function c999999992.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-2
		and Duel.CheckReleaseGroup(tp,c999999992.spfilter,2,nil,c)
end
function c999999992.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c999999992.spfilter,2,2,nil,c)
	c:SetMaterial(g)
