...
function c999999967.initial_effect(c)
	...
	e7:SetCondition(c999999967.spcon)
	e7:SetOperation(c999999967.spop)
	c:RegisterEffect(e7)
	...
	e8:SetTarget(c999999967.target)
...
function c999999967.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-2
		and Duel.CheckReleaseGroup(tp,c999999967.spfilter,2,nil,c)
end
function c999999967.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c999999967.spfilter,2,2,nil,c)
	c:SetMaterial(g)
