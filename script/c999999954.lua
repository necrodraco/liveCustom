...
function c999999954.initial_effect(c)
	...
	e100:SetValue(c999999954.splimit)
	...
	e99:SetCondition(c999999954.spcon)
	e99:SetOperation(c999999954.spop)
	...
	e98:SetTarget(c999999954.target)
...
function c999999954.splimit(e,se,sp,st)
	return e:GetHandler():GetLocation()~=LOCATION_EXTRA
end
function c999999954.spfilter(c,fc)
	return c999999954.matfilter(c)
end
function c999999954.spcon(e,c)
	...
	return ft>-2
		and Duel.IsExistingMatchingCard(c999999954.spfilter,tp,LOCATION_ONFIELD,nil,2,nil,tp,ft)
end
function c999999954.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c999999954.spfilter,tp,LOCATION_MZONE,nil,nil,tp)
