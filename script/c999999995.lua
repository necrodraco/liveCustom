...
function c999999995.initial_effect(c)
	...
	e100:SetValue(c999999995.splimit)
	...
	e99:SetCondition(c999999995.spcon)
	e99:SetOperation(c999999995.spop)
	...
	e98:SetTarget(c999999995.target)
...
function c999999995.spcon(e,c)
	...
	return ft>-2
		and Duel.IsExistingMatchingCard(c999999995.spfilter,tp,LOCATION_ONFIELD,nil,2,nil,tp,ft)
end
function c999999995.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c999999995.spfilter,tp,LOCATION_MZONE,nil,nil,tp)
	local g1=g:Select(tp,2,2,nil)
	Duel.SendtoGrave(g1,REASON_COST)
end
--Borrowed from Area A
function c999999995.target(e,c)
	return c:GetCode() == 999999995
end