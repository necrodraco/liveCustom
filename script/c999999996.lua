...
function c999999996.initial_effect(c)
	...
	e6:SetValue(c999999996.splimit)
	c:RegisterEffect(e6)
	--special summon rule
	...
	e7:SetCondition(c999999996.spcon)
	e7:SetOperation(c999999996.spop)
	c:RegisterEffect(e7)
	...
	e8:SetTarget(c999999996.target)
...
function c999999996.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-2
		and Duel.CheckReleaseGroup(tp,c999999996.spfilter,2,nil,c)
end
function c999999996.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c999999996.spfilter,2,2,nil,c)
	c:SetMaterial(g)
