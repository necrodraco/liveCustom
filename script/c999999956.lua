...
function c999999956.initial_effect(c)
	...
	e100:SetValue(c999999956.splimit)
	...
	e99:SetCondition(c999999956.spcon)
	e99:SetOperation(c999999956.spop)
	...
	e98:SetTarget(c999999956.target)
...
function c999999956.splimit(e,se,sp,st)
	return e:GetHandler():GetLocation()~=LOCATION_EXTRA
end
function c999999956.spfilter(c,fc)
	return c999999956.matfilter(c)
end
function c999999956.spcon(e,c)
	...
	return ft>-2
		and Duel.IsExistingMatchingCard(c999999956.spfilter,tp,LOCATION_ONFIELD,nil,2,nil,tp,ft)
end
function c999999956.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c999999956.spfilter,tp,LOCATION_MZONE,nil,nil,tp)
